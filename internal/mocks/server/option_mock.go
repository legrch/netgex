...
import (
	server "github.com/legrch/netgex/server"
...
func (_m *Option) Execute(_a0 *server.Server) {
	_m.Called(_a0)
}
...
func (_c *Option_Execute_Call) Run(run func(_a0 *server.Server)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*server.Server))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*server.Server)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
