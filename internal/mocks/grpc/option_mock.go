...
import (
	grpc "github.com/legrch/netgex/internal/grpc"
...
func (_m *Option) Execute(_a0 *grpc.Server) {
	_m.Called(_a0)
}
...
func (_c *Option_Execute_Call) Run(run func(_a0 *grpc.Server)) *Option_Execute_Call {
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*grpc.Server)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
